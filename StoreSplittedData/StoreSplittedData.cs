            ...
            ExecutionContext context)
        {
            ...
            if (message.Properties.ContainsKey("msgtype"))
            {
                if (message.Properties["msgtype"].ToString() == "split")
                {
                    ...
                    string unitSize = message.Properties["unitsize"].ToString();
                    ...
                    if (string.IsNullOrEmpty(orchId))
                    {
                        ...
                        log.LogInformation($"Response StatusCode={response.StatusCode} from {webhookNotifyUrl}");
                    ...
                    {
                        // error
                        log.LogError($"Notification Error - orchestrationId is null!");
                    }
